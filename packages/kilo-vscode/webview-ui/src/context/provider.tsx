...
const DEFAULT_SELECTION: ModelSelection = { providerID: "openai", modelID: "" }
...
export const ProviderProvider: ParentComponent = (props) => {
  ...
  const [defaultSelection, setDefaultSelection] = createSignal<ModelSelection>(DEFAULT_SELECTION)
